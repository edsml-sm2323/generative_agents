...
from integration_core.views import ExperimentListView, PhaserGameEmbedView, VideoHLSView, ExperimentCreateView, ExperimentDetailView, ExperimentStartView, ExperimentStatusView,ExperimentStopView # 引入 ExperimentListView 视图集
...
urlpatterns = [    
    ...
    path('experimentStartView/',ExperimentStartView.as_view(),name='experiment_start'),
